...
namespace Modules\TomatoHr\App\Models;
...
class Employee extends Authenticatable implements HasMedia, Wallet
{
    ...
    {
        return $this->hasMany('Modules\TomatoHr\App\Models\EmployeeAttendance');
    }
    ...
    {
        return $this->hasMany('Modules\TomatoHr\App\Models\EmployeeMeta');
    }
    ...
    {
        return $this->hasMany('Modules\TomatoHr\App\Models\EmployeePayment');
    }
    ...
    {
        return $this->hasMany('Modules\TomatoHr\App\Models\EmployeePayroll');
    }
    ...
    {
        return $this->hasMany('Modules\TomatoHr\App\Models\EmployeeRequest');
    }
    ...
    {
        return $this->belongsTo('Modules\TomatoHr\App\Models\AttendanceShift');
    }
    ...
    {
        return $this->belongsTo('Modules\TomatoHr\App\Models\Department', 'department_id', 'id');
    }
