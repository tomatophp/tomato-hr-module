...
namespace Modules\TomatoHr\App\Tables;
...
class EmployeeAttendanceTable extends AbstractTable
{
    ...
    {
        if(!$query){
            $this->query = \Modules\TomatoHr\App\Models\EmployeeAttendance::query();
        }
    }
    ...
    public function configure(SpladeTable $table)
    {
        $table
            ...
            ->bulkAction(
                ...
                each: fn (\Modules\TomatoHr\App\Models\EmployeeAttendance $model) => $model->delete(),
