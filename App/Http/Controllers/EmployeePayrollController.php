...
use Modules\TomatoHr\App\Models\EmployeeAttendance;
use Modules\TomatoHr\App\Models\EmployeePayroll;
use Modules\TomatoHr\App\Models\EmployeeRequest;
...
class EmployeePayrollController extends Controller
{
    ...
    {
        $this->model = \Modules\TomatoHr\App\Models\EmployeePayroll::class;
    }
    ...
    public function index(Request $request): View|JsonResponse
    {
        return Tomato::index(
            ...
            table: \Modules\TomatoHr\App\Tables\EmployeePayrollTable::class
        );
    }
    ...
    public function api(Request $request): JsonResponse
    {
        return Tomato::json(
            request: $request,
            model: \Modules\TomatoHr\App\Models\EmployeePayroll::class,
        );
    }
    ...
    /**
     * @param \Modules\TomatoHr\App\Models\EmployeePayroll $model
     * @return View|JsonResponse
     */
    public function show(\Modules\TomatoHr\App\Models\EmployeePayroll $model): View|JsonResponse
    {
        return Tomato::get(
            model: $model,
     ...
     * @return View
     */
    public function edit(\Modules\TomatoHr\App\Models\EmployeePayroll $model): View
    {
        return Tomato::get(
            model: $model,
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function update(Request $request, \Modules\TomatoHr\App\Models\EmployeePayroll $model): RedirectResponse|JsonResponse
    {
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function destroy(\Modules\TomatoHr\App\Models\EmployeePayroll $model): RedirectResponse|JsonResponse
    {
