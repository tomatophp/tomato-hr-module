...
class EmployeeController extends Controller
{
    ...
    {
        $this->model = \Modules\TomatoHr\App\Models\Employee::class;
    }
    ...
    public function index(Request $request): View|JsonResponse
    {
        return Tomato::index(
            ...
            table: \Modules\TomatoHr\App\Tables\EmployeeTable::class,
            filters: [
                "department_id",
                "user_id"
            ]
    ...
    public function api(Request $request): JsonResponse
    {
        return Tomato::json(
            request: $request,
            model: \Modules\TomatoHr\App\Models\Employee::class,
            filters: [
                "department_id",
                "user_id"
            ]
    ...
    /**
     * @param \Modules\TomatoHr\App\Models\Employee $model
     * @return View|JsonResponse
     */
    public function show(\Modules\TomatoHr\App\Models\Employee $model): View|JsonResponse
    {
        return Tomato::get(
            model: $model,
     ...
     * @return View
     */
    public function edit(\Modules\TomatoHr\App\Models\Employee $model): View
    {
        return Tomato::get(
            model: $model,
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function update(Request $request, \Modules\TomatoHr\App\Models\Employee $model): RedirectResponse|JsonResponse
    {
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function destroy(\Modules\TomatoHr\App\Models\Employee $model): RedirectResponse|JsonResponse
    {
