...
class EmployeeAttendanceController extends Controller
{
    ...
    {
        $this->model = \Modules\TomatoHr\App\Models\EmployeeAttendance::class;
    }
    ...
    public function index(Request $request): View|JsonResponse
    {
        return Tomato::index(
            ...
            table: \Modules\TomatoHr\App\Tables\EmployeeAttendanceTable::class
        );
    }
    ...
    public function api(Request $request): JsonResponse
    {
        return Tomato::json(
            request: $request,
            model: \Modules\TomatoHr\App\Models\EmployeeAttendance::class,
        );
    }
    ...
    /**
     * @param \Modules\TomatoHr\App\Models\EmployeeAttendance $model
     * @return View|JsonResponse
     */
    public function show(\Modules\TomatoHr\App\Models\EmployeeAttendance $model): View|JsonResponse
    {
        return Tomato::get(
            model: $model,
     ...
     * @return View
     */
    public function edit(\Modules\TomatoHr\App\Models\EmployeeAttendance $model): View
    {
        return Tomato::get(
            model: $model,
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function update(Request $request, \Modules\TomatoHr\App\Models\EmployeeAttendance $model): RedirectResponse|JsonResponse
    {
        $total = 0;
        $delay = 0;
        $overtime = 0;
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function destroy(\Modules\TomatoHr\App\Models\EmployeeAttendance $model): RedirectResponse|JsonResponse
    {
