...
use Modules\TomatoHr\App\Http\Controllers\DepartmentController;
use Modules\TomatoHr\App\Http\Controllers\AttendanceShiftController;
use Modules\TomatoHr\App\Http\Controllers\EmployeeController;
use Modules\TomatoHr\App\Http\Controllers\EmployeeAttendanceController;
use Modules\TomatoHr\App\Http\Controllers\EmployeeRequestController;
use Modules\TomatoHr\App\Http\Controllers\EmployeePaymentController;
use Modules\TomatoHr\App\Http\Controllers\EmployeePayrollController;
use Modules\TomatoHr\App\Http\Controllers\EmployeeApplyController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
